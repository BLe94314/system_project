                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <?php echo htmlspecialchars($row['author_id']); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                        href="edit_author.php?author_id=<?php echo $row['author_id']; ?>">Edit</a>
                                    <a class="btn btn-sm btn-danger"
                                        href="delete_author.php?author_id=<?php echo $row['author_id']; ?>"
